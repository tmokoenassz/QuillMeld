 ...
 * This file demonstrates how to integrate Quillmeld with a web frontend
 */

// For React/Vue/Angular applications
export class QuillmeldClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new QuillmeldClient(provider, contractAddress);
